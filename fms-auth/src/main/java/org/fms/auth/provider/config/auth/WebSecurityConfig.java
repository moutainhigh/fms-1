package org.fms.auth.provider.config.auth;


import org.fms.auth.provider.config.auth.provider.MyAuthenticationProvider;
import org.fms.auth.provider.service.BaseUserDetailService;
