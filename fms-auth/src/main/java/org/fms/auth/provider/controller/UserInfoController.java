...
import org.fms.auth.provider.pojo.request.UserInfoRequest;
import org.fms.auth.provider.service.UserInfoService;
 ...
 */
@RestController
public class UserInfoController extends CrudController<UserInfo, UserInfoRequest> {
