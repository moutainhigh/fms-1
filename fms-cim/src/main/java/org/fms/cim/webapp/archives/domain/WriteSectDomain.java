...
public class WriteSectDomain extends ManagerParamEntity implements MybatisEntity {
	...
	private int tInitNum;   //应初始化数
	private int InitedNum;	//已初始化数
	private Integer mon;//电费月份
	
	private Long writeSectId;// ID bigint TRUE FALSE TRUE
	...
	public int gettInitNum() {
		return tInitNum;
	}

	public void settInitNum(int tInitNum) {
		this.tInitNum = tInitNum;
	}
